...
par$prgm_dir <- 'stable'
par$prgm_tag <- 'stable_MSA_imProbeQC'
par$verbose  <- 3
local_paths  <- c( 
...
man_csv <- file.path( opt$top_path, "Projects.new/MSA/MethylationQC/MSAv03/manifest/MSAv03_probes.csv.gz" )
man_csv <- file.path( opt$top_path, "data/manifests/methylation/EX/MSAEX03/MSA-Interm-48v0-3_SS_BP123_A1.csv.gz" )
