...
doc_a1_full_csv <- file.path( opt$probe_man_dir, "EPIC-A1.manifest.sesame-base.cpg-sorted.csv.gz" )
...
doc_a1_full_tib <- rnk_a1_body_tib %>%
  ...
  dplyr::select( Probe_ID,M,U,DESIGN,COLOR_CHANNEL,col,
                 Probe_Type,Probe_Source,Next_Base,Probe_Design,mask,Full_ID ) %>%
  clean_tib() %>%
...
#.       - Remove 'mask' field
#        - leave col=NA for Inf2
#        - Update from A1 to E2
...
#.  for more details...
#
# docker cp /Users/bbarnes/Documents/scratch/stable_scratch_EPICv2_docker_snps/EPICv2-UCSC-v3/probe/man/EPIC-A1.manifest.sesame-base.cpg-sorted.csv.gz dd00d8b92b93:/repo/Infinium_Methylation_Workhorse/dat/manifest.core/
#
# docker cp /Users/bbarnes/Documents/scratch/stable_scratch_EPICv2_docker_snps/EPICv2-UCSC-v3/docker/dat/EPICv2/EPICv2.annoS.rds dd00d8b92b93:/repo/Infinium_Methylation_Workhorse/dat/dbSNP/b151/EPIC-A1/EPIC-A1.annoS.rds
# docker cp /Users/bbarnes/Documents/scratch/stable_scratch_EPICv2_docker_snps/EPICv2-UCSC-v3/docker/dat/EPICv2/EPICv2.annoI.rds dd00d8b92b93:/repo/Infinium_Methylation_Workhorse/dat/dbSNP/b151/EPIC-A1/EPIC-A1.annoI.rds
