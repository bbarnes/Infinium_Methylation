                                     ...
                                     fun_tag='swifthoof_sesame_options')
{
  ...
  if (pars$run_mode == 'RStudio') {
    ...
    if ( pars$run_name == "GSIBIOINFO-597" ) {
      ...
      opts$idat_path <- file.path( pars$top_path, "Projects.new/EPIC_v2",pars$run_name,"idats" )
      
      opts$genomestudio <- paste(
        file.path( pars$top_path, "Projects.new/EPIC_v2",pars$run_name,"Manifests/EPIC-with-ManifestGeneratorTool/EPICv1GRCh37-NA-NA-GRCh37.csv.gz" ),
        file.path( pars$top_path, "Projects.new/EPIC_v2",pars$run_name,"Manifests/EPICv2/EPICv2_SMG_2022_09_12_1125-NA-NA-GRCh37_1A.csv.gz" ),
        sep=COM
      )
      ...
      opts$sample_sheets <- paste(
        file.path( pars$top_path, "Projects.new/EPIC_v2",pars$run_name,"SampleSheets/SampleSheet-LightningAuto.csv.gz" ),
        file.path( pars$top_path, "Projects.new/EPIC_v2",pars$run_name,"SampleSheets/SampleSheet-LightningAuto_EPICv2-only.csv.gz" ),
        file.path( pars$top_path, "Projects.new/EPIC_v2",pars$run_name,"SampleSheets/SampleSheet-LightningAuto_EPIC-only.csv.gz" ),
        
        file.path( pars$top_path, "Projects.new/EPIC_v2",pars$run_name,"SampleSheets/SampleSheet-LightningManual.csv.gz" ),
        file.path( pars$top_path, "Projects.new/EPIC_v2",pars$run_name,"SampleSheets/SampleSheet-LightningManual_EPIC-only.csv.gz" ),
        file.path( pars$top_path, "Projects.new/EPIC_v2",pars$run_name,"SampleSheets/SampleSheet-LightningManual_EPICv2-only.csv.gz" ),
        
        file.path( pars$top_path, "Projects.new/EPIC_v2",pars$run_name,"SampleSheets/SampleSheet-EZ-DNA-Manual.csv.gz" ),
        file.path( pars$top_path, "Projects.new/EPIC_v2",pars$run_name,"SampleSheets/SampleSheet-EZ-DNA-Manual-EPIC-only.csv.gz" ),
        file.path( pars$top_path, "Projects.new/EPIC_v2",pars$run_name,"SampleSheets/SampleSheet-EZ-DNA-Manual_EPICv2-only.csv.gz" ),
        sep=COM
      )
